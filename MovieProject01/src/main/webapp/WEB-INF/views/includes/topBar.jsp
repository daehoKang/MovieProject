...
<!-- includes/topBar.jsp -->
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form action="searchMovie" method="get" onsubmit="return searchFormCheck();"
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" id="movieSearch" name="movieSearch" class="form-control bg-light border-0 small" placeholder="Search for..."
                        ...
                        <c:choose>
                         <c:when test="${sessionScope.loginId != null}">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">아이디 : ${sessionScope.loginId }</span>
                                
                             <c:choose>
                                <c:when test="${sessionScope.loginProfile != null }">
                                	<img class="img-profile rounded-circle"
                                    	src="${pageContext.request.contextPath }/resources/profile/${sessionScope.loginProfile }">
                                </c:when>
                                <c:otherwise>
                                	<img class="img-profile rounded-circle"
